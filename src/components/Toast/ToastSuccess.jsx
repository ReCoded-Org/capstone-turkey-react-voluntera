...
export default function ToastSuccess({ submitted, message }) {
  return (
    ...
    >
      ...
      <button
        type="button"
        className="ml-auto -mx-1.5 -my-1.5 bg-green-200 text-gray-400 hover:text-red-500 rounded-lg focus:ring-2 focus:ring-red-300 p-1.5 hover:bg-red-100 inline-flex h-8 w-8 00 white  "
